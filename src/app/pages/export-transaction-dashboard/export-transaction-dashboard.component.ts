...
export class ExportTransactionDashboardComponent {
  ...
  constructor(private el: ElementRef, private router: Router,
    private dashboardService: DashboardDataService, private dialog: MatDialog, private overlay: Overlay) { }
  ...
  private buildDetailsFields(row: any): DetailField[] {
    ...
    if (this.currentDetailView === 'adBranch') {
      return [
        ...
        { label: 'Dealer Code', value: row.brnDlrCode ?? '-' },

        { label: 'Swift Code', value: row.brnSwfCode },
        { label: 'Dealer Code', value: row.brnDlrCode ?? '-' },
